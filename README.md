...
![Description](images/C:\Users\DELL\Downloads\baseic.jpg)
### Explanation:
...
| HR03 | User shall be able to Exit the game || HR04 | User shall lose|
| HR05 | User shall win|
| HR06 | User shall end up in a Draw situation|
| HR07 | User shall be able to choose help to play game |
...
| LR05 | If the user presses '3', it'll exit the game. | HR03 |
| LR05 | If the user presses '4', he'll go to the help option. | HR07 |
